class Solution {
    public int networkDelayTime(int[][] times, int N, int K) {
        ...
        /* after getting the minimum distance (travel time) to all points, we should retrieve the max distance from these minimum distances, 
         * To ensure that we can travel to all points in a specific travel time
        */
        int result = 0;
        for (int i = 1; i <= N; i++) {
